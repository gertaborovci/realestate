...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2026 at 05:11 PM
...
--
-- Table structure for table `agencyexpenses`
--
...
--
-- Dumping data for table `agencyexpenses`
--

INSERT INTO `agencyexpenses` (`id`, `category`, `amount`, `description`, `expense_date`, `created_at`) VALUES
(1, 'Maintenance', 350.00, 'Kosto e riparimit për tiketën', '2026-06-22', '2026-05-25 11:52:13'),
(2, 'Utilities', 200.00, 'Monthly office rent - Headquarters downtown', '2026-06-25', '2026-05-25 14:56:26');
...
INSERT INTO `maintenancetickets` (`id`, `property_id`, `tenant_id`, `title`, `description`, `status`, `created_at`) VALUES
(1, 1, 1, 'Riparimi i Bojlerit', 'Bojleri ne katin e dyte ka rrjedhje uji dhe duhet ndrruar ventili urgjentisht.', 'Resolved', '2026-05-25 15:03:09'),
(2, 1, 1, 'Inspektimi i Sistemit HVAC', 'Sistemi i klimes nuk po ftoh ashtu siç duhet ne dhomen kryesore.', 'Pending', '2026-05-25 15:03:09');
...
--
-- Indexes for table `agencyexpenses`
--
...
--
-- AUTO_INCREMENT for table `agencyexpenses`
--
ALTER TABLE `agencyexpenses`
