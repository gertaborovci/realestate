...
const ContractTransactionsPage = () => {
  ...
  const refresh = useCallback(() => { loadTransactions(); loadContracts(); }, [loadTransactions, loadContracts]);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/40 text-xs font-bold tracking-widest uppercase mt-1">
            Payment records linked to purchase contracts
          </p>
        </div>
        <button onClick={refresh} className="flex items-center gap-2 text-white/40 hover:text-white transition text-[10px] font-bold uppercase tracking-widest">
